...
def print_banner():
    """打印欢迎横幅"""
    banner = """
[bold cyan]Lx Skills Agent[/bold cyan]
[dim]测试Agent解决支付中心的问题[/dim]
...
"""
    console.print(Panel(banner, title="Lx Agent Demo", border_style="cyan"))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Lx Skills Agent -（支持流式输出和 Extended Thinking）",
