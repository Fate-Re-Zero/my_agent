...
使用 LangChain 的 create_agent API 实现 Skills Agent：
...
class LangChainSkillsAgent:
    ...
    def _build_system_prompt(self) -> str:
        ...
        """
        base_prompt = """You are a helpful Payment Assistant with access to specialized skills.
