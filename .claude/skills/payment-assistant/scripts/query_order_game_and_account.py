"""
查下订单是否充值到xx游戏的，和提供账号信息脚本

使用方式:
    uv run query_order_game_and_account.py "订单号"
"""
...
def query_order_game_and_account(
    order_id: str,
    ...
    Returns:
        0 表示成功，1 表示失败
    """
    print(f"query_order_game_and_account function, Start, Order ID: {order_id}")

    # 1. 查询订单状态
    log_info("Order Info...")
    try:
        log_info(f"query_order_game_and_account function, Invoke Query Order Interface, Order ID: {order_id}")
...
def main():
    ...
    # 执行提取
    return query_order_game_and_account(
