...
使用 LangChain 构建的 Skills Agent，演示 自定义Skills 的效果。
...
# 交互式运行
uv run lx-skills --interactive

# 单次执行
uv run lx-skills "列出当前目录"

# 查看发现的 Skills
uv run lx-skills --list-skills

# 查看 System Prompt
uv run lx-skills --show-prompt
```
